        ...
        ListView {
            ...
            delegate: Column {
                ...
                Component.onCompleted: {
                    console.log("Message: ", message.isSentByMe);
                }
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        width: Math.min(messageText.implicitWidth + 24, listView.width - (!conversationDelegate.isSentByMe ? avatar.width + messageRow.spacing : 0))
                        ...
                        Label {
                            ...
                            text: conversationDelegate.message.body
                            wrapMode: Label.Wrap
                        }
                    }
                }
                Label {
                    ...
                    anchors.right: conversationDelegate.message.isSentByMe ? parent.right : undefined
                    color: "lightgrey"
                    text: Qt.formatDateTime(conversationDelegate.message.sentAt, "d MMM hh:mm")
                }
            }
